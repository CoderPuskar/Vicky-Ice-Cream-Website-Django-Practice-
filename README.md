Vicky Ice Cream Wala – A fun, practice project to build a website using Django. Created for learning and experimenting with Django, web development, and backend concepts in a hands-on way<br>
